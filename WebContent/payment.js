...
function handlePageLoad(returnedData) {
    $("#price").append("$".concat(returnedData["total_price"]));
}
...
$.ajax(
    {
        ...
        success: (returnedData) => handlePageLoad(returnedData)
    }
);
...
function handleLoginResult(resultDataJson) {
    ...
    if (resultDataJson["success"] === true) {
        ...
        $("#login_error_message").text(resultDataJson["errorMessage"]);
    }
}
